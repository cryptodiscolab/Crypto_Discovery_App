...
| Platform Fee (Raffle) | `20%` (Fixed v3.17.0) |
| Whitelist Mode | `Multi-Chain Dynamic (v3.17.0)` |
| Revenue Split (UGC) | `80% Creator / 20% Platform` |
| Treasury Wallet | `0xAfB7C7E711418EFD744f74B4D92c2b91B9668fAa` |

## 💰 Kompetensi Inti

### 1. P&L Control (Profit & Loss v3.17.0)
...
- **6-Tier Distribution**: Support for None through Diamond tiers indexing (v3.17.0).
...
## 📋 Checklist Profitabilitas (v3.17.0)
