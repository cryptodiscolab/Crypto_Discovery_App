...
## 🏛️ Verified Infrastructure Reference (v3.20.0)
...
| **PRD v3.20.0** | `[ACTIVE]` | `PRD/PRD_Crypto_Disco_v3.20.0.md` | `DOC_SOT` |
...
## 📋 Checklist Security & Infra (v3.20.0)
- [ ] Apakah kontrak yang digunakan adalah versi terbaru (PRD v3.20.0)?
...
---
*Protokol ini sinkron dengan .cursorrules dan PRD v3.20.0*
