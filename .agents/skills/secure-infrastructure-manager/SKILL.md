...
## 🏛️ Verified Infrastructure Reference (v3.25.0)
...
| **PRD v3.25.0** | `[ACTIVE]` | `PRD/PRD_Crypto_Disco_v3.25.0.md` | `DOC_SOT` |
...
## 📋 Checklist Security & Infra (v3.25.0)
- [ ] Apakah kontrak yang digunakan adalah versi terbaru (PRD v3.25.0)?
...
---
*Protokol ini sinkron dengan .cursorrules dan PRD v3.25.0*
