...
const SYNC_REGISTRY = [
    ...
    'VITE_DAILY_APP_V16_ADDRESS', 'V15_CONTRACT_ADDRESS',
...
const KEY_MAPPINGS = {
    ...
    'VITE_NEYNAR_SIGNER_UUID': 'NEYNAR_SIGNER_UUID',
    'TWITTER_BEARER_TOKEN': 'X_MONASQUE_BEARER_TOKEN',
    'TWITTER_API_KEY': 'X_MONASQUE_CLIENT_ID',
    'TWITTER_API_SECRET': 'X_MONASQUE_CLIENT_SECRET'
};
...
const TARGET_FILES = [
    ...
    'verification-server/.env.example'
];
