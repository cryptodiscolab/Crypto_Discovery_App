...
const keysToSync = [
    ...
    // Telegram / AI
    'TELEGRAM_BOT_TOKEN', 'TELEGRAM_CHAT_ID', 'GEMINI_API_KEY', 'GEMINI_API_KEY_2', 'GEMINI_API_KEY_3', 
    'GEMINI_API_KEY_4', 'GEMINI_API_KEY_5', 'GEMINI_API_KEY_6', 'GEMINI_API_KEY_7', 'GEMINI_API_KEY_8', 'GEMINI_API_KEY_9',
    'CHAT_ID',
    ...
    'NEYNAR_API_KEY', 'NEYNAR_SIGNER_UUID', 'VITE_NEYNAR_SIGNER_UUID',
...
const SENSITIVE_KEYS = [
    ...
    'X_MONASQUE_BEARER_TOKEN', 'X_MONASQUE_CLIENT_SECRET',
    'TWITTER_BEARER_TOKEN', 'TWITTER_API_SECRET'
];
