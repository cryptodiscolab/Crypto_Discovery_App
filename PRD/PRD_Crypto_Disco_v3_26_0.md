...
**Version**: 3.26.0 — Identity Sync & RPC Resilience Update
...
|---|---|---|---|
| **Identity & Resilience** | 3.26.0 | SQL View fix, RPC Lag Fallback, UGC Modal TDZ fixes | CURRENT |
...
- **[RESOLVED] RPC Lag Fallback**: Implemented Direct RPC verification for Daily Claims via transaction hashes.
