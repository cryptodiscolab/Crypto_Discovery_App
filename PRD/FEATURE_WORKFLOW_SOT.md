...
## ≡ƒÅ¢∩╕Å 0. Active Contract Index & Network Registry (DO NOT DEVIATE)
...
## ≡ƒöæ 1. Login & Identity Management Flow
...
## ≡ƒÄü 2. Daily Claim Workflow (The "Optimistic Trust" Model)
...
## ≡ƒÅå 3. Leaderboard & Database View Synchronization
...
> [!WARNING]
> Database **tidak memiliki trigger otomatis** yang mengagregasi `user_task_claims ΓåÆ user_profiles.total_xp`. Hanya ada `trg_referral_bonus`. Jangan berharap XP tersinkron secara pasif.

---

## ≡ƒÅà 4. Tier Rank Recalculation (Database Driven)
...
## ≡ƒÜª 6. Definisi "Healthy State" Ekosistem (CHECKLIST)
...
8. [ ] **Contract Call Parity**: Setiap contract write call HARUS menggunakan contract yang SAMA dengan sumber data read-nya. Mint data dari DAILY_APP ΓåÆ write ke DAILY_APP (v3.47.1).
...
## ≡ƒöü 7. End-to-End Synchronization Audit Workflow
...
## ≡ƒÜª 8. Mainnet Phased Rollout & Global Kill Switch
...
## ≡ƒÆ╝ 5. UGC Revenue Management & Transaction History Flow (v3.40.12)
...
## ≡ƒÅ¢∩╕Å 9. XP Reward Lifecycle & Anti-Whale Economic Model (v3.41.2)
...
## ≡ƒÅ¢∩╕Å 10. Referral Growth Loop v2 (Vesting & Dividends)
...
## ≡ƒÅ¢∩╕Å 11. Base Social Verification (Identity Link)
...
9. XP Economy & Hybrid Formula (G ├ù I ├ù U)
...
## ≡ƒÅ¢∩╕Å 13. Raffle Moderation & Refund Workflow (Protocol V2.1)
...
## ≡ƒæü∩╕Å 14. Lurah Sentinel & Sync State Architecture (v3.56.5)
...
## ≡ƒÅ¢∩╕Å 15. UGC Multi-Action & All-or-Nothing Campaign Workflow (v3.57.0)
...
## ≡ƒÅ¢∩╕Å 16. Ecosystem Infrastructure Hardening & Zero-Hardcode Mandate (v3.59.1)
...
## ≡ƒÅ¢∩╕Å 17. Ecosystem Hardening & Parity Audit Workflow (v3.59.2)
...
## ≡ƒÅ¢∩╕Å 18. DailyApp V14 Multi-Token Sponsorship & Decimal Normalization (v3.59.3)
...
## ≡ƒÅ¢∩╕Å 19. Daily Goal Retention Loop (Milestone 3-Tasks Bonus) ΓÇö v3.59.4
...
## ≡ƒÅ¢∩╕Å 20. Manual Accountant Ledger Sync Protocol (v3.59.4)
...
## ≡ƒÅ¢∩╕Å 21. Raffle Platform Economics & Creator Withdrawal Flow (v3.59.5)
