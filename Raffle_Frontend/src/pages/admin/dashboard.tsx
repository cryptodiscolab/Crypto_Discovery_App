 ...
 */
const UserReputationTable = lazy(() => import('../../features/admin/components/UserReputationTable'));
const SBTRewardsDashboard = lazy(() => import('../../components/SBTRewardsDashboard').then(module => ({ default: module.SBTRewardsDashboard })));
const TaskManager = lazy(() => import('../../features/admin/components/TaskManager').then(module => ({ default: module.TaskManager })));
const TaskClaimLogs = lazy(() => import('../../features/admin/components/TaskClaimLogs'));
const AdminSystemSettings = lazy(() => import('../../features/admin/components/AdminSystemSettings'));
