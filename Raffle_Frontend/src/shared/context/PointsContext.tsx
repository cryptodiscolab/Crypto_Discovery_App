...
interface EcosystemSettings {
    ...
    referral_active_threshold: number;
}
...
export function PointsProvider({ children }: { children: React.ReactNode }) {
    ...
    const addSyncLog = useCallback((type: string, dbXp: number, visualXp: number, prevVisualXp: number | null = null) => {
        const log = {
            id: Date.now(),
    ...
    const checkAdminStatus = async (walletAddress: string | undefined) => {
    ...
    const manualAddPoints = (amount: number) => {
