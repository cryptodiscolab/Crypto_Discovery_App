...
// ============================================================
interface PoolStats {
    diamond_holders: number;
    platinum_holders: number;
    gold_holders: number;
    silver_holders: number;
    bronze_holders: number;
    share_legendary: number;
    share_epic: number;
    share_rare: number;
    share_common: number;
...
// ============================================================
function NexusEconomyPanel({ multipliers, totalUsers }: { multipliers: Multipliers; totalUsers: number }) {
    return (
