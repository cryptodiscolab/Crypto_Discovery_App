...
export function AuditLogsSection({ logs }: { logs: unknown[] }) {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 max-w-[100vw] overflow-x-hidden">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-md font-black text-white uppercase tracking-[0.2em] leading-none">System Audit Trail</h2>
                        <p className="label-native text-slate-500 mt-2 font-mono">Cryptographically signed administrative actions</p>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="bg-black/40 border border-white/5 rounded-xl pl-9 pr-4 py-2 label-native text-white focus:outline-none focus:border-indigo-500/50 transition-all w-full md:w-48 font-mono"
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-2 bg-black/40 border border-white/5 rounded-xl px-3 py-2">
                        ...
                        <select
                            ...
                            className="bg-transparent label-native text-slate-300 focus:outline-none cursor-pointer"
                        >
                    ...
                    <div className="flex items-center gap-2 px-3 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
                        ...
                        <span className="label-native text-emerald-500 font-mono">Secured</span>
                    </div>
                </div>
            </div>

            <div className="bg-[#121214] rounded-2xl border border-white/5 overflow-hidden backdrop-blur-sm shadow-2xl">
                                ...
                                <tr>
                                    <td colSpan={4} className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center gap-3 opacity-30">
                                            ...
                                            <p className="label-native text-slate-500">No logs match your filter criteria</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
                                    ...
                                    <React.Fragment key={log.id}>
                                        ...
                                        >
                                            <td className="px-6 py-5 whitespace-nowrap">
                                                <div className="flex flex-col gap-1">
                                                    <div className="flex items-center gap-2">
                                                        <span className="value-native text-slate-200 font-mono">
                                                    ...
                                                    <span className="label-native text-slate-600 font-mono flex items-center gap-1.5">
                                            ...
                                            <td className="px-6 py-5">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-slate-800 to-black border border-white/10 flex items-center justify-center label-native text-indigo-400 shadow-inner group-hover:border-indigo-500/50 transition-all">
                                                        {log.admin_address?.slice(2, 4).toUpperCase() || 'SYS'}
                                                    </div>
                                                    <div className="flex flex-col">
                                                        <span className="label-native text-slate-300 font-mono">
                                                            {log.admin_address?.includes('SYSTEM') ? 'Kernel Process' : 'Admin Authority'}
                                                        </span>
                                                        <span className="label-native font-mono text-slate-500">
                                            ...
                                            <td className="px-6 py-5">
                                                <div className="flex items-center gap-4">
                                                    <div className={`px-2.5 py-1 rounded-md border label-native ${getActionColor(log.action)}`}>
                                            ...
                                            <td className="px-6 py-5 text-right">
                                                <div className="flex items-center justify-end gap-2 text-emerald-500 bg-emerald-500/5 px-3 py-1.5 rounded-xl w-fit ml-auto border border-emerald-500/10 backdrop-blur-md">
                                                    ...
                                                    <span className="label-native">Verified</span>
                                                </div>
                                            </td>
                                        </tr>
                                        {expandedLog === log.id && (
                                                ...
                                                <td colSpan={4} className="px-12 py-6">
                                                    <div className="space-y-4">
                                                        <div className="flex items-center gap-2 mb-2">
                                                            ...
                                                            <span className="label-native text-white">Execution Payload</span>
                                                        </div>
                                                        <div className="p-4 bg-black/60 rounded-xl border border-white/5 font-mono value-native text-slate-300 leading-relaxed shadow-2xl">
            ...
            <div className="bg-indigo-500/5 border border-indigo-500/10 p-5 rounded-2xl flex items-start gap-4">
                ...
                <div className="space-y-1">
                    <h4 className="label-native text-white">Protocol Integrity Notice</h4>
                    <p className="label-native text-slate-500 italic leading-relaxed">
